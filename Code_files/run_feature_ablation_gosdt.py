...
OUT_DIR = BASEDIR / "feature_ablation_results_gosdt"
...
def run_one(dataset_name, param_tag, tgb_dir):
    ...
    summary_path = out_dir / "ablation_summary_gosdt.json"
...
def main():
    ...
    if rows:
        ...
        summary_df.to_csv(OUT_DIR / "summary_gosdt.csv", index=False)
        print(f"\nSummary saved to {OUT_DIR / 'summary_gosdt.csv'}")
