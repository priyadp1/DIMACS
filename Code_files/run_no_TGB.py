...
RESULTS_DIR = BASEDIR / "benchmarks_no_TGB_results_all"
...
for dataset_name, cfg in DATASETS.items():
    ...
    # Save splits for GOSDT subprocess / downstream plotting (PaCMAP, etc.)
    ...
    #     f.write(f"\nAll Features:\n{cb_importance_df.to_string(index=False)}")
